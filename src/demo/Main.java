...
public class Main {
	public static void main(String[] args) {
		...
		Wizard wizard = new Wizard("阿部晴明", "魔法");
		...
		while (true) {
			...
			// 人間グループから1人選択
	        Human firstHuman = choiceHuman(humans);
			
			// モンスターグループから1人選択
	        Monster firstMonster = choiceMonster(monsters);
	        
	        System.out.println();
            
			// 選ばれた人間が、選ばれたモンスターを攻撃
	        
	        firstHuman.attack(firstMonster);
        	System.out.println();
	        ...
	        if (firstMonster.getHp() <= 0) {
	        	...
	        	System.out.println("★「"+firstMonster.getName()+"」は倒れた");
	        	System.out.println();
	        }
			...
			// 人間グループから1人選択
	        Human secondHuman = choiceHuman(humans);
			
			// モンスターグループから1人選択
			
	        Monster secondMonster = choiceMonster(monsters);
	        
	        System.out.println();
	        
			// 選ばれたモンスターが、選ばれた人間を攻撃
	        
	        secondMonster.attack(secondHuman);
        	System.out.println();
	        

			// 人間のHPが0以下になれば、人間は倒れ、その人間をモンスターグループから削除

	        if (secondHuman.getHp() <= 0) {
	        	humans.remove(secondHuman);
	        	System.out.println("★「"+secondHuman.getName()+"」は倒れた");
	        	System.out.println();
	        }
